...
function DreamForm() {
  ...
  return (
    <div className="mt-16 max-w-xl mx-auto p-6 bg-gray-900 rounded-lg shadow-lg text-white">
      <div className="flex justify-center mb-6">
        <img src={dreamImage} alt="Dream" className="w-60 h-60 object-cover rounded-full border-4 border-gray-700 mb-8" />
      </div>
      <div className="mb-10 text-center text-lg font-semibold text-blue-300 animate-fade-in">
      ...
      />
      <button
        className="w-full bg-blue-500 text-white py-2 rounded hover:bg-blue-700 transition-colors duration-300 disabled:opacity-50 mb-16"
