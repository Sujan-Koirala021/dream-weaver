    ...
    <div className='bg-slate-200'>
      <div className='flex flex-row items-center justify-between p-4'>
        ...
        <div className={`hidden md:flex md:flex-row md:items-center ${isOpen ? 'flex flex-col w-full' : ''}`}>
          <Link to="/" className='block p-4 text-gray-700 '>Home</Link>
          <Link to="/about" className='block p-4 text-gray-700 '>About</Link>
          <Link to="/contact-us" className='block p-4 text-gray-700 '>Contact Us</Link>
